...
class RAGAnythingConfig:
    ...
    enable_handwriting_processing: bool = field(
        default=get_env_value("ENABLE_HANDWRITING_PROCESSING", False, bool)
    )
    """Enable handwriting content processing (using Vintern)."""
